...
/**
 * {@link SecretProviderPort} backed by Azure Key Vault. When the vault URL is
 * present the bean becomes {@link Primary} so it is transparently preferred
 * over the {@link PropertySecretAdapter}.
 */
@Component
@Primary
