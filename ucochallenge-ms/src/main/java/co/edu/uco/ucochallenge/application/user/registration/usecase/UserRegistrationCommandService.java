...
import co.edu.uco.ucochallenge.application.user.registration.validator.UserRegistrationDomainValidator;
...
@Service
@Transactional
public class UserRegistrationCommandService implements UserRegistrationCommandUseCase {

        private static final Logger LOGGER = LoggerFactory.getLogger(UserRegistrationCommandService.class);
        ...
        private final UserRegistrationContactConfirmationPort contactConfirmationPort;
        private final UserRegistrationIdTypeQueryPort idTypeQueryPort;
        private final UserRegistrationLocationQueryPort locationQueryPort;
        private final Supplier<UUID> idGenerator;
        private final UserRegistrationDomainValidator validator;

        public UserRegistrationCommandService(final UserRegistrationRepositoryPort repositoryPort,
                        final UserRegistrationNotificationPort notificationPort,
                        final UserRegistrationContactConfirmationPort contactConfirmationPort,
                        final UserRegistrationIdTypeQueryPort idTypeQueryPort,
                        final UserRegistrationLocationQueryPort locationQueryPort,
                ...
                this.validator = new UserRegistrationDomainValidator(repositoryPort, notificationPort, idGenerator);
        }
