...
/**
 * Centralized exception for the platform. It enforces the identification of
 * the exception type (user or technical) and the layer where it was generated.
 * Instead of storing literal messages, it keeps references (keys) that are
 * later resolved through the message-service.
 */
